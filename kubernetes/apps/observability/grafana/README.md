...
-   MinIO dashboard added as Grafana CRD (`kubernetes/apps/observability/grafana/dashboards/minio.yaml`) - requires exporter metrics.
-   Tailscale overview dashboard added as Grafana CRD (`kubernetes/apps/observability/grafana/dashboards/tailscale.yaml`).
