...
- Single-cluster upgrades still need strict node health gates before progressing.
...
- Apply this runbook with a controlled maintenance window and active monitoring.
